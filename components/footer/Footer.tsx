    ...
    <footer className="bg-inverse-surface dark:bg-zinc-950 w-full py-20 px-4 md:px-margin-desktop border-t border-outline/20 z-20 text-white/80 mt-auto">
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 w-full max-w-container-max mx-auto">
        ...
        <div className="col-span-12 md:col-span-4 space-y-6">
          <Link href="/" className="font-playfair text-2xl font-bold tracking-tight text-white inline-block">
            MARK <span className="font-light italic text-tertiary-fixed-dim">Architects</span>
          </Link>
        ...
        <div className="col-span-6 md:col-span-2 space-y-4">
          <h4 className="font-inter text-xs font-bold text-tertiary-fixed uppercase tracking-wider">Navigation</h4>
          <ul className="space-y-2.5 font-inter text-sm font-light">
            <li>
              <Link href="/" className="hover:text-tertiary-fixed transition-colors">
                Home Studio
              </Link>
            </li>
            <li>
              <Link href="/portfolio" className="hover:text-tertiary-fixed transition-colors">
                Selected Works
              </Link>
            </li>
            <li>
              <Link href="/services" className="hover:text-tertiary-fixed transition-colors">
                Services Grid
              </Link>
            </li>
            <li>
              <Link href="/collection" className="hover:text-tertiary-fixed transition-colors">
                Store Collection
              </Link>
            </li>
          </ul>
        ...
        {/* Resources Section */}
        <div className="col-span-6 md:col-span-2 space-y-4">
          <h4 className="font-inter text-xs font-bold text-tertiary-fixed uppercase tracking-wider">Resources</h4>
          <ul className="space-y-2.5 font-inter text-sm font-light">
            <li>
              <a className="hover:text-tertiary-fixed transition-colors" href="#">
                Blueprint Access
              </a>
            </li>
            <li>
        ...
        <div className="col-span-12 md:col-span-4 space-y-4">
          <h4 className="font-inter text-xs font-bold text-tertiary-fixed uppercase tracking-wider">Studios</h4>
          <ul className="space-y-3 font-inter text-sm font-light">
            ...
            <li className="flex items-start gap-2">
              ...
              <span> 4A, AL Haj Sher Tower, Ring Rd, Near Hayatabad, Peshawar</span>
            </li>
          </ul>
        </div>
