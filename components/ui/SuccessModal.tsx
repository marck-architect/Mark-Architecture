      ...
      {successModal.isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="glass-panel max-w-md w-full bg-white/95 dark:bg-zinc-900/95 rounded-3xl p-8 text-center space-y-6 shadow-2xl z-10"
          >
            <div className="w-16 h-16 bg-tertiary/10 rounded-full flex items-center justify-center mx-auto text-tertiary">
              <CheckCircle className="w-10 h-10" />
            </div>
            <h3 className="font-playfair text-2xl font-bold text-secondary dark:text-zinc-100">
              {successModal.title}
            </h3>
